...
public class HistoryFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        historyList.add(new History("急診","腿一直在抖,無法停止",R.drawable.ic_home_black_24dp));
        historyList.add(new History("出診","北榮小兒科",R.drawable.ic_chat));
        historyList.add(new History("諮詢","台大醫科神經科",R.drawable.ic_dashboard_black_24dp));
